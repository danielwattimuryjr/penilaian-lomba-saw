...
export default function Menu({ setOpen }) {
    ...
    return (
        <ul className='space-y-3 px-2 py-5 lg:px-4'>
            ...
            <li>
                <PrimaryLink onSuccess={closeSidebar} href={route('contests.index')} active={route().current('contests.*')} className='flex items-center gap-x-3.5 rounded-lg p-2 text-[0.920rem]/[1.35rem]'>
                    <Icon icon={'IconTournament'} />
                    Perlombaan
                </PrimaryLink>
            </li>
